    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-creme/90 backdrop-blur-md border-b border-line">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-8">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-2 bg-verde text-creme text-sm font-body font-500 px-5 py-2.5 rounded-full hover:bg-verde-light transition-colors duration-200"
        >
          <WhatsAppIcon />
          Agendar
        </a>
        ...
        {/* Mobile menu toggle */}
        <button
          className="md:hidden text-verde p-1"
      ...
      {open && (
        <div className="md:hidden bg-creme border-t border-line px-6 py-4 flex flex-col gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 bg-verde text-creme text-sm font-body font-500 px-5 py-3 rounded-full mt-2"
          >
            <WhatsAppIcon />
